...
public class HBaseAdmin1_2 implements AdminMask
{

    private static final Logger log = LoggerFactory.getLogger(HBaseAdmin1_2.class);

    private final Admin adm;

    public HBaseAdmin1_2(HBaseAdmin adm)
    {
        this.adm = adm;
    }
    @Override
